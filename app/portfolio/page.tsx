...
const projects = [
  ...
  },
  {
    ...
    description: 'A real-time weather application with forecasts, radar maps, and location-based services.',
  ...
  },
  {
    ...
    description: 'An application for tracking personal finances, expenses, and creating financial goals.',
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A showcase of my projects and applications built with modern technologies.
          </p>
        </header>
